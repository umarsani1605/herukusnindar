...
export default function Biography() {
  return (
    <>
      {/* Features */}
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-48 mx-auto text-lg md:mb-10">
        {/* Grid */}
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-2 md:space-y-4">
                ...
                <p className="text-gray-500">
                  Sed posuere purus quis arcu vulputate molestie. Fusce fermentum ac augue in dignissim. Sed tincidunt quis lectus ut pharetra. Sed nec sapien vitae erat tincidunt feugiat in a dolor.
                </p>
              </div>
              {/* End Title */}
            </div>
